            ...
            return SizedBox(
              ...
              child: InkWell(
                ...
                child: VideoCard(
                    ...
                    subtitle: videoController.list[index].videoDescription,
...
GetBuilder<VideoController> playList(double height, double width) {
  return GetBuilder<VideoController>(
    builder: (videoController) {
      return videoController.isLoaded
          ? Container(
            ...
            return SizedBox(
              ...
              child: InkWell(
                ...
                child: Padding(
                  ...
                  child: playlistCard(
                      title:videoController.list[index].title,
                      descriptions:videoController.list[index].videoDescription ,
                      imageUrl: videoController.list[index].imageUrl),
                ),
              ),
            );
